/**
 * @file Manager.js
 * @description Abstract base class providing Active/Reserve pool management.
 */
...
export class Manager {
    ...
    // Accessors
    // ------------------------------------------------------------
    baseGetActive() { return this.poActive; }
    baseSetActive(pNode) { this.poActive = pNode; }
    ...
    baseDump() {
        console.log("\n****** Manager Begin ******");
        console.log(`mDeltaGrow: ${this.mDeltaGrow} | mTotalNodes: ${this.mTotalNumNodes}`);
        console.log(`mNumReserved: ${this.mNumReserved} | mNumActive: ${this.mNumActive}`);
    ...
    // Abstract Contracts
    // ------------------------------------------------------------
    derivedCreateNode() { throw new Error("derivedCreateNode must be implemented"); }
    derivedCompare(pLinkA, pLinkB) { throw new Error("derivedCompare must be implemented"); }
    derivedWash(pLink) { throw new Error("derivedWash must be implemented"); }
    derivedDumpNode(pLink) { throw new Error("derivedDumpNode must be implemented"); }
